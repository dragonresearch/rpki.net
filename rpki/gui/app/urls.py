...
urlpatterns = patterns(
    ...
    url(r'^conf/list$', views.conf_list,name='conf-list'),
    url(r'^conf/select$', views.conf_select, name='select-conf'),
    ...
    url(r'^client/import$', views.client_import, name='client-import'),
    url(r'^client/$', views.client_list, name='repository-client-list'),
    url(r'^client/(?P<pk>\d+)/$', views.client_detail, name='client-detail'),
    url(r'^client/(?P<pk>\d+)/delete$', views.client_delete, name='client-delete'),
    ...
    url(r'^resource_holder/$', views.resource_holder_list, name='resource-holder-list'),
    url(r'^resource_holder/create$',
        views.resource_holder_create,
        name='create-resource-holder'),
