...
"""
Classes to represent IP addresses.  These are mostly obsolete at this
point, having been replaced by the rpki.POW.IPAddress class, but there
may still be some code using these, so keep them for now for backwards
compatability.
